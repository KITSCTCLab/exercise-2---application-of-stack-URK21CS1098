...
if (len(operands)+len(operators))==len(expression) and
len(operands)==len(operators)+
1:
return expression[0] not in operators and expression[1] not in operators def
evaluate_postfix_expression(self, expression):
